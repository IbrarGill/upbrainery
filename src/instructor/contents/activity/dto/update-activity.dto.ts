...
export class ContentBlocksUpdateDto {
  @ApiPropertyOptional()
  @IsNumber()
  id: number | null
...
export class ContentResourceUpdateDto {
  @ApiProperty()
  id: number | null
...
export class UpdateActivityDto extends PartialType(CreateActivityDto) {
  ...
  @IsArray()
  @IsOptional()
  @Type(() => ContentBlocksUpdateDto)
  activityBlock: ContentBlocksUpdateDto[];
